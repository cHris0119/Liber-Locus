...
urlpatterns = [
    ...
    path('api/users/get_all_follow/', vg.get_Follows_followers, name='get_all_follow'), # obtener los seguidores y seguidos de la sesion actual
    path('api/users/get_all_follow_user/<int:user_id>', vg.get_Follows_followers_users, name='get_all_follow_user'), # obtener los seguidores de los usuario
