  ...
  return (
    <HomeSection>
      <div className="suscriptions-container">
        <h2>Suscripciones</h2>
        <div className="suscriptions-grid">
          {suscriptions.map((suscription) => (
            <article className='suscription' key={suscription.id}>
              <div className="suscription-details">
                <h3>{suscription.duration}</h3>
                <p>{suscription.price} CLP</p>
                <div className="benefits-container">
                  <div className="benefits">
                    <svg className='benefits-svg' width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button className='suscription-button'>Comprar ahora</button>
            </article>
          ))}
        </div>
      </div>
